...
class Soc(object):
  ...
  def __init__(self, tp):
    ...
    has_second_timer  = tp.get('soc/peripherals/fc_timer_1') is not None
    ...
    if has_fc:
      if has_fc_ico:
        ...
        if has_second_timer:
          apb_soc_mappings["fc_timer_1"] = get_mapping(tp.get_child_dict("soc/peripherals/fc_timer_1"), True)
