...
CNN_LIB = $(TILER_CNN_KERNEL_PATH)/CNN_CopyBasicKernels.c $(TILER_CNN_KERNEL_PATH_SQ8)/CNN_AT_Misc.c $(NNTOOL_KERNELS_PATH)/norm_transpose.c $(NNTOOL_MATH_PATH)/math_funcs.c
CNN_LIB_INCLUDE = -I$(TILER_CNN_KERNEL_PATH) -I$(NNTOOL_KERNELS_PATH) -I$(NNTOOL_MATH_PATH)
...
ifdef MODEL_FP16
  ...
  CNN_LIB += $(MODEL_LIB_FP16) $(NNTOOL_MATH_PATH)/math_funcs.c
