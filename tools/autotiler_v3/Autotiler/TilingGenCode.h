...
extern int TileNAddressAndSize(Kernel_T *Ker, Kernel_Arg_T *Arg, int N, int *Address, int *Size, int *Length);
extern int LogicalTileNAddressAndSize(Kernel_T *Ker, Kernel_Arg_T *Arg, int N, int *Address, int *Size, int *Length);
